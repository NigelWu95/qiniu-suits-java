...
public class UploadFile extends OperationBase implements ILineProcess<Map<String, String>>, Cloneable {

    final private int status;

    public UploadFile(String accessKey, String secretKey, Configuration configuration, String bucket, int status,
    ...
    synchronized public BucketManager.BatchOperations getOperations(List<Map<String, String>> lineList) {
