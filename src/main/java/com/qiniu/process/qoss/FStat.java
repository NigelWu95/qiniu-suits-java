...
public class FStat extends Base {
    ...
    public FStat(String accessKey, String secretKey, Configuration configuration, String bucket, String rmPrefix,
    ...
    public FStat clone() throws CloneNotSupportedException {
        FStat fileStat = (FStat)super.clone();
