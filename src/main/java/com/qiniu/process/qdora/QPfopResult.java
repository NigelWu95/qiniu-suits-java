...
public class QPfopResult extends Base {

    final private String pidIndex;
    private MediaManager mediaManager;
    private Gson gson;

    public QPfopResult(String pidIndex, String savePath, int saveIndex) throws IOException {
    ...
    public QPfopResult(String persistentIdIndex, String savePath) throws IOException {
        this(persistentIdIndex, savePath, 0);
    }

    public QPfopResult clone() throws CloneNotSupportedException {
        QPfopResult pfopResult = (QPfopResult)super.clone();
