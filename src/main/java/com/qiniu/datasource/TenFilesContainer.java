...
public class TenFilesContainer implements IDataSource {
    ...
    public TenFilesContainer(String secretId, String secretKey, ClientConfig clientConfig, String bucket,
...
//                retry = HttpResponseUtils.checkException(e, retry);
    ...
    private List<TenLister> nextLevelLister(TenLister tenLister) {
        ...
        List<COSObjectSummary> cosObjectSummaries = tenLister.currents();
