...
public class TenObjectsContainer implements IDataSource {
    ...
    public TenObjectsContainer(String secretId, String secretKey, ClientConfig clientConfig, String bucket,
