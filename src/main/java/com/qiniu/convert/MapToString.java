...
public class MapToString extends Converter<Map<String, String>, String> {
    ...
    public MapToString(String format, String separator, Map<String, String> indexMap, List<String> rmFields) throws IOException {
        if (separator == null) throw new IOException("separator can not be null.");
        fields = LineUtils.getFields(
                new ArrayList<>(indexMap != null ? indexMap.values() : LineUtils.defaultFileFields), rmFields
        );
