...
public class DownloadFile extends Base<Map<String, String>> {
    ...
    public DownloadFile(Configuration configuration, String domain, String protocol, String urlIndex, String addPrefix,
    ...
    public DownloadFile(Configuration configuration, String domain, String protocol, String urlIndex, String addPrefix,
        ...
        this(configuration, domain, protocol, urlIndex, addPrefix, rmPrefix, savePath, 0);
    }
    ...
    protected String singleResult(Map<String, String> line) throws Exception {
        ...
        line.put("key", key);
        downloader.download(url, fileSaveMapper.getSavePath() + FileUtils.pathSeparator + key);
        return "success";
    }
