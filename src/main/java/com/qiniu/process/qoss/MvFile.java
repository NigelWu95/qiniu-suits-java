...
public class MvFile extends Base {
    ...
    public MvFile(String accessKey, String secretKey, Configuration configuration, String bucket, String toBucket,
    ...
    public MvFile clone() throws CloneNotSupportedException {
        MvFile moveFile = (MvFile)super.clone();
