...
public class CpFile extends Base {
    ...
    public CpFile(String accessKey, String secretKey, Configuration configuration, String bucket, String toBucket,
    ...
    public CpFile clone() throws CloneNotSupportedException {
        CpFile copyFile = (CpFile)super.clone();
