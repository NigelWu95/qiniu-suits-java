...
public class UpYOssContainer extends OssContainer<FileItem, BufferedWriter, Map<String, String>> {

    private String username;
    private String password;
    private UpYunConfig configuration;

    public UpYOssContainer(String username, String password, UpYunConfig configuration, String bucket,
